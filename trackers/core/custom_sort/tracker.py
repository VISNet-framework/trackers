...
from trackers.core.custom_sort.kalman_box_tracker import CustomSORTKalmanBoxTracker
    ...
    def _spawn_new_trackers(
        ...
        for detection_idx in unmatched_detections:
            if (
                ...
                new_tracker = CustomSORTKalmanBoxTracker(detection_boxes[detection_idx])
